...
<div class="container-fluid hero-header bg-light py-5 mb-5">
    <div class="container py-5">
        ...
        <div class="col-lg-6">
            <h1 style="font-size: 2.5rem;" class="display-4 mb-3 animated slideInDown">Giant Book Supplier, <br> Best Book Store and Supplier in Indonesia</p>
            </div>
...
<div class="containerBook" style="background-color: rgb(0, 0, 0,0.1)">
    <div class="BookList">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\WEB\uts_webprogramming\resources\views/index.blade.php ENDPATH**/ ?>